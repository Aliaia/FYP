...
<head>
    ...
    <?php 
        ...
        $personalData = getData('Users', ['_id' => new MongoDB\BSON\ObjectID($_GET['id'])])->toArray();
        $medication = json_encode($personalData[0]);
        // print_r($medication);
    ...
    <div class="container2">
        ...
        <nav class="navigation">
          	...
          	<ul class="Nav-bar">
                ...
                <li><a href=<?php echo("'diastolicSystolicAndMedication.php?id=" . $_GET['id'] . "'") ?> class="active"> Diastolic, Systolic and medication changes </a></li>
                <li><a href= <?php echo("'pulse.php?id=" . $_GET['id'] . "'") ?>> Pulse </a></li>
            </ul>
        </nav>
        
        <div class="content">     
            <div class="title"> Diastolic and Systolic Pressure with Medication Changes </div>
        ...
        <script type="text/javascript">
            ...
            var medication = <?php print_r($medication)?>;
            medication = medication['Extension2']['ValueCodeableConcept'];
            ...
            var width = 1200;
            var height = 450;
            var margin = {top: 40, right: 420, bottom: 70, left: 50};
            ...
            vis.append("text")
                ...
                .text("Diastolic and Systolic Pressure with Medication Changes over Time");
            ...
            for(drug in medication) {
                console.log(new Date(medication[drug][2]));

                vis.append("line")
                    .attr("x1", xScale(new Date(medication[drug][2])) + margin.left)
                    .attr("y1", margin.top)
                    .attr("x2", xScale(new Date(medication[drug][2])) + margin.left)
                    .attr("y2", height - margin.bottom)
                    .style("stroke-width", 2)
                    .style("stroke", colorOrder[0]);

                vis.append("rect")
                    .attr("transform", "translate(" + (width - margin.right + 180) + "," + legendHeight + ")")
                    .attr("width", "15")
                    .attr("height", "15")
