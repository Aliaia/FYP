    ...
    <div class="container2">
        ...
        <nav class="navigation">
            ...
            <ul class="Nav-bar">
                ...
                <li><a href= <?php echo("'pulse.php?id=" . $_GET['id'] . "'") ?> class="active" > Pulse </a></li>
            </ul>
        </nav>
        
        <div class="content">     
            <div class="title"> Pulse Over Time </div>
        ...
        <!-- Create Graph -->
        <script type="text/javascript">
            var variables = ['Pulse', 'Identification'];
            ...
            function handleMouseOver(data, index) {
                ...
                if(d3.select(this).data()[0].hasOwnProperty('Pulse') ) {
                    pulse = d3.select(this).data()[0]['Pulse'];
                }

                var tableRows = d3.selectAll("tr").filter( function(d){
                    if (d == null) {
                        return false
                    } else if (d.hasOwnProperty('Pulse')) {
                        return ((new Date(d['DateTime']).getTime() == date.getTime()) && (d['Pulse']['Measure'] == pulse));
                    }
                })
        ...
        <script type="text/javascript">
            ...
            function tableMouseOver(data, index) {
                ...
                if(d3.select(this).data()[0].hasOwnProperty('Pulse') ) {
                    pulse = d3.select(this).data()[0]['Pulse']['Measure'];
                }

                var circles = d3.selectAll("circle").filter( function(d){
                    console.log(pulse);
                    return ((d['Date'].getTime() == date.getTime()) && (d['Pulse'] == pulse));
